    ...
    >
      ...
      <div className="relative pt-10  lg:pt-6 text-white p-8 h-full">
        <RiCloseLine
          ...
          className=" absolute left-4 top- p-1 box-content text-gray-300 bg-[#262837] rounded-full text-xl"
        />
              ...
              <div key={product.id} className="bg-white p-4 w-30 rounded-xl mb-4">
                ...
                <div className="grid grid-cols-6 items-center">
                  <form className="col-span-5">
                    <input
                      type="text"
                      className="bg-amber-200 px-4 rounded-lg outline-none"
        ...
        {/* Submit payment */}
        <div className="bg-amber-400 text-xl lg:text-base border border-white borde-10 absolute w-full bottom-0 left-0 p-4 lg:p-2">

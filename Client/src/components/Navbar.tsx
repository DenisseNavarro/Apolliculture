    ...
    return (
      ...
      <nav className="bg-amber-400 py:5 lg:py-5 relative ">
        ...
        <div className='flex justify-center lg:mt-[-60px]'>
          <IoSearchOutline className="absolute mt-3 "/>
          <input className=" mb-5 bg-white border border-amber-500 text-black w-8/12 h-7  lg:w-6/12 h-9 rounded-3xl px-4 outline-none" type='text' placeholder="Search..." />
          </div>
      </nav>
    );
  };
